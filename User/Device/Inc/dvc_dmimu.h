...
//#define DM_IMU_YAW_OFFSET (0.70781f)
#define DM_IMU_YAW_OFFSET (0.000004515619f)
...
{
    DM_IMU_Status_DISABLE = 0,
    DM_IMU_Status_ENABLE,
};
...
public:
	...
	inline Enum_DM_IMU_Status Get_DM_IMU_Status();
...
protected:
	imu_t Data;
	Enum_DM_IMU_Status DM_IMU_Status = DM_IMU_Status_DISABLE;
};

inline Enum_DM_IMU_Status Class_DM_IMU::Get_DM_IMU_Status()
{
    return DM_IMU_Status;
}
#endif