...
typedef uint16_t BUZZER_CALIBRATING_TICK_TO_TONE_LUT_T; enum
{
  ...
  BUZZER_CALIBRATING_STEP2_PLAY_TONE_F5 = 1700,
  BUZZER_CALIBRATING_STEP3_BUZZER_SWITCH_OFF = 2000,
  BUZZER_CALIBRATING_STEP4_BUZZER_RELEASE = 2300,
};
...
// // 测试警报1各音调的时间点
// typedef uint16_t BUZZER_TEST1_TICK_TO_TONE_LUT_T; enum
// {
// 	BUZZER_DEVICE_OFFLINE_STEP1_PLAY_TONE_C5 = 0,
// 	BUZZER_DEVICE_OFFLINE_STEP1_PLAY_TONE_C5 = 300,
// 	BUZZER_DEVICE_OFFLINE_STEP1_PLAY_TONE_C5 = 600,
// 	BUZZER_DEVICE_OFFLINE_STEP1_PLAY_TONE_C5 = 900,
// 	BUZZER_DEVICE_OFFLINE_STEP4_BUZZER_RELEASE = 1200,
// };
typedef struct {
	uint32_t clkFreq;
	uint16_t psc;
